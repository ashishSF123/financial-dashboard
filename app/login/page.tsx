    ...
    <div className="min-h-screen bg-[#0a0b10] flex items-center justify-center">
      <div className="bg-[#12131a] border border-white/[0.08] rounded-2xl p-8 max-w-sm w-full text-center">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white/[0.06] border border-white/[0.1] text-white text-[0.85rem] font-medium hover:bg-white/[0.1] transition-colors"
          >
        ...
        <p className="text-[0.65rem] text-slate-600 mt-5">Only authorized GitHub accounts can access this dashboard</p>
      </div>
    </div>
  );
}
